...
"""
	pluto_mathjax_local::Bool
	pluto_mathjax_local(flag::Bool)::Bool

Eventually set the flag to force mathjax svg output in pluto to be locally cached and return its current value.
